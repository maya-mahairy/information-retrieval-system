flowchart TD
    ...
    subgraph OFFLINE["Offline Data Preparation Flow"]
        ...
        BUILD["Index Building Scripts<br/>build_tfidf_index.py<br/>build_bm25_index.py<br/>build_embedding_index.py"]
    end

    subgraph EVALUATION["Evaluation and Reporting Flow"]
        EV["Evaluation Service<br/>evaluation_service.py<br/>evaluate_models.py"]
        CH["Chart Service<br/>evaluation_chart_service.py<br/>generate_evaluation_charts.py"]
